...
As you may know, Rust is one of my favorite tools. I code in Rust since 2015 and I can say that I got my fair part of quirks, misunderstandings, and errors.
...
Even if Rust nightly has a lot of bells and whistles, don't succumb to them. You are a beginner and the stable language is large enough. If you need something in nightly you probably are over-engineering your problem, want to [shave a yak](https://www.hanselman.com/blog/YakShavingDefinedIllGetThatDoneAsSoonAsIShaveThisYak.aspx), or misunderstood what you want to do. I encourage you to research your problem a step further and look for stable solutions.
...
[Rustfmt](https://github.com/rust-lang/rustfmt#quick-start) is a formatting tool for Rust source code. It rewrites your code in a way that is commonly agreed on on the community, and avoid any coding-style war.
...
*Note: Clippy will sometimes disagree. You can follow its advice, but don't be keen to revert to `String` if you feel the need for it.*
